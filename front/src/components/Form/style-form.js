...
const sombraNeon = keyframes`
    0% {
      box-shadow: 0 0 5px #0288D1, 0 0 7px #0288D1, 0 0 9px #0288D1, 0 0 11px #0288D1, 0 0 13px #0288D1, 0 0 15px #0288D1, 0 0 17px #0288D1, 0 0 19px #0288D1;
    }
    50% {
...
const sombraNeonMobile = keyframes`
    0% {
      box-shadow: 0 0 2px #4CAF50, 0 0 5px #4CAF50, 0 0 6px #4CAF50, 0 0 7px #4CAF50, 0 0 8px #4CAF50, 0 0 9px #4CAF50, 0 0 10px #4CAF50, 0 0 11px #4CAF50;
    }
    50% {
